...
- HTTPS setup according to `/1_developer-experience-tests/envoy-gw/2-envoy-gw-https.md`

### Install Envoy Gateway

Deploy Envoy Gateway with some minor changes compared to the developer experience tests:
...
Test rolling updates by downgrading to Helm chart version 1.5.0, which will downgrade EnvoyProxy to v1.35.0:
